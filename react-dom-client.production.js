import { r as reactDomClient_production } from "./__Users_robertwebb_reproductions_vite-project_node_modules_.pnpm_react-dom@19.2.4_react@19.2.4_node_modules_react-dom_cjs_react-dom-client.production.js_commonjs-exports-Dq84yY-X.js";
import { r as requireScheduler } from "./_Users_robertwebb_reproductions_vite-project_node_modules_.pnpm_scheduler@0.27.0_node_modules_scheduler_index.js-DnK_ZaI6.js";
import { r as requireReact } from "./_Users_robertwebb_reproductions_vite-project_node_modules_.pnpm_react@19.2.4_node_modules_react_index.js-BTwSOY7S.js";
import { r as requireReactDom } from "./_Users_robertwebb_reproductions_vite-project_node_modules_.pnpm_react-dom@19.2.4_react@19.2.4_node_modules_react-dom_index.js-NOkQOHQU.js";
...
function requireReactDomClient_production() {
  ...
  var REACT_MEMO_CACHE_SENTINEL = /* @__PURE__ */ Symbol.for(
  ...
  function checkIfRootIsPrerendering(root2, renderLanes2) {
    return (
      0 ===
      (root2.pendingLanes &
        ~(root2.suspendedLanes & ~root2.pingedLanes) &
        renderLanes2)
    );
  }
  ...
  function markRootEntangled(root2, entangledLanes) {
    ...
    for (root2 = root2.entanglements; rootEntangledLanes; ) {
      var index$8 = 31 - clz32(rootEntangledLanes),
        lane = 1 << index$8;
      (lane & entangledLanes) | (root2[index$8] & entangledLanes) &&
        (root2[index$8] |= entangledLanes);
  ...
  function getBumpedLaneForHydration(root2, renderLanes2) {
    ...
    return 0 !== (renderLane & (root2.suspendedLanes | renderLanes2))
      ? 0
      : renderLane;
  }
  ...
  function pushTreeId(workInProgress2, totalChildren, index2) {
    ...
    if (30 < length) {
      ...
      (treeContextId =
        (1 << length) | (index2 << baseLength) | baseIdWithLeadingBit),
  ...
  function propagateParentContextChanges(
    ...
    current = null;
    for (
      var parent = workInProgress2, isInsidePropagationBailout = !1;
      null !== parent;
    ...
    switch (thenable.status) {
      ...
      default:
        if ("string" === typeof thenable.status) thenable.then(noop$1, noop$1);
          ...
          if (
            null !== thenableState2 &&
            100 < thenableState2.shellSuspendCounter
          )
  ...
  function resetHooksOnUnwind(workInProgress2) {
    if (didScheduleRenderPhaseUpdate) {
      for (
        workInProgress2 = workInProgress2.memoizedState;
        null !== workInProgress2;
  ...
  function updateOffscreenComponent(
    ...
    null === current &&
      null === workInProgress2.stateNode &&
    ...
    if ("hidden" === nextProps.mode) {
      if (0 !== (workInProgress2.flags & 128)) {
        prevState =
          null !== prevState
            ? prevState.baseLanes | renderLanes2
            : renderLanes2;
        if (null !== current) {
      ...
      if (0 !== (renderLanes2 & 536870912))
        ...
        return (
          (nextProps = workInProgress2.lanes = 536870912),
  ...
  function deferHiddenOffscreenComponent(
    ...
    pushOffscreenSuspenseHandler(workInProgress2);
    null !== current &&
      propagateParentContextChanges(current, workInProgress2, renderLanes2, !0);
  ...
  function updateActivityComponent(current, workInProgress2, renderLanes2) {
    ...
    if (null === current) {
      if (isHydrating) {
        if ("hidden" === nextProps.mode)
          return (
            (current = mountActivityChildren(workInProgress2, nextProps)),
        ...
        (current = nextHydratableInstance)
          ? ((current = canHydrateHydrationBoundary(
            ...
            null !== current &&
              ...
              (renderLanes2 = createFiberFromDehydratedFragment(current)),
    ...
    if (null !== prevState) {
      ...
      if (didSuspend)
        ...
        (didSuspend = 0 !== (renderLanes2 & current.childLanes)),
        didReceiveUpdate || didSuspend)
      ) {
        nextProps = workInProgressRoot;
        if (
          null !== nextProps &&
          ((dehydrated = getBumpedLaneForHydration(nextProps, renderLanes2)),
        ...
        (current = prevState.treeContext),
          ...
          (rootOrSingletonContext = !1),
          null !== current &&
            restoreSuspendedTreeContext(workInProgress2, current),
          (workInProgress2 = mountActivityChildren(workInProgress2, nextProps)),
  ...
  function updateSuspenseComponent(current, workInProgress2, renderLanes2) {
    ...
    JSCompiler_temp && ((showFallback = !0), (workInProgress2.flags &= -129));
      ...
      if (didSuspend)
        workInProgress2.flags & 256
          ...
          : (reuseSuspenseHandlerOnStack(),
            ...
            (workInProgress2.memoizedState = SUSPENDED_MARKER),
            (workInProgress2 = bailoutOffscreenComponent(null, nextProps)));
      else if (
        (pushPrimaryTreeSuspenseHandler(workInProgress2),
    ...
    if (showFallback)
      return (
        ...
        null === nextPrimaryChildren
          ? (nextPrimaryChildren = mountSuspenseOffscreenState(renderLanes2))
    ...
    null !== current &&
      ...
      null === JSCompiler_temp
        ? ((workInProgress2.deletions = [current]),
  ...
  function initSuspenseListRenderState(
    ...
    null === renderState
      ...
      : ((renderState.isBackwards = isBackwards),
        ...
        (renderState.treeForkCount = treeForkCount2));
  }
      ...
      case "forwards":
        ...
        null === renderLanes2
          ? ((revealOrder = workInProgress2.child),
            (workInProgress2.child = null))
          : ((revealOrder = renderLanes2.sibling),
            (renderLanes2.sibling = null));
  ...
  function checkScheduledUpdateOrContext(current, renderLanes2) {
    if (0 !== (current.lanes & renderLanes2)) return !0;
    current = current.dependencies;
    ...
    switch (workInProgress2.tag) {
          ...
          null === current
            ? (renderLanes2 = getResource(
              ...
              : isHydrating ||
                ...
                (props[internalInstanceKey] = workInProgress2),
                (props[internalPropsKey] = current),
                setInitialProperties(props, renderLanes2, current),
                markNodeAsHoistable(props),
                (workInProgress2.stateNode = props))
      ...
      case 27:
        return (
          ...
          null === current &&
            isHydrating &&
            ((props = workInProgress2.stateNode =
      ...
      case 10:
        return (
          (props = workInProgress2.pendingProps),
          pushProvider(workInProgress2, workInProgress2.type, props.value),
          reconcileChildren(
            current,
            workInProgress2,
            props.children,
      ...
      case 9:
        return (
          ($$typeof = workInProgress2.type._context),
          (props = workInProgress2.pendingProps.children),
          prepareToReadContext(workInProgress2),
          ...
          null === current
            ? (($$typeof = peekCacheFromPool()),
              null === $$typeof &&
                ...
                prevState.refCount++,
                null !== prevState &&
                  ($$typeof.pooledCacheLanes |= renderLanes2),
                ($$typeof = prevState)),
              (workInProgress2.memoizedState = {
                parent: props,
                cache: $$typeof,
              ...
              initializeUpdateQueue(workInProgress2),
              pushProvider(workInProgress2, CacheContext, $$typeof))
            : (0 !== (current.lanes & renderLanes2) &&
              ...
              $$typeof.parent !== props
                ? (($$typeof = { parent: props, cache: props }),
                  (workInProgress2.memoizedState = $$typeof),
                  0 === workInProgress2.lanes &&
                    (workInProgress2.memoizedState =
  ...
  function preloadInstanceAndSuspendIfNeeded(
    ...
    if ((type = 0 !== (workInProgress2.mode & 32))) type = !1;
    if (type) {
      if (
        ((workInProgress2.flags |= 16777216),
        (renderLanes2 & 335544128) === renderLanes2)
      )
  ...
  function scheduleRetryEffect(workInProgress2, retryQueue) {
    ...
    workInProgress2.flags & 16384 &&
      ((retryQueue =
        22 !== workInProgress2.tag ? claimNextRetryLane() : 536870912),
  ...
  function completeWork(current, workInProgress2, renderLanes2) {
    ...
    switch (workInProgress2.tag) {
      ...
      case 3:
        ...
        workInProgress2.memoizedState.cache !== newProps &&
      ...
      case 26:
        ...
        null === current
          ...
          : ((current = current.memoizedProps),
            current !== newProps && markUpdate(workInProgress2),
            bubbleProperties(workInProgress2),
            preloadInstanceAndSuspendIfNeeded(
              workInProgress2,
              type,
      ...
      case 5:
        ...
        if (null !== current && null != workInProgress2.stateNode)
          ...
          if (popHydrationState(workInProgress2))
            ...
            a: for (
              ownerDocument = workInProgress2.child;
              null !== ownerDocument;
              ...
              for (; null === ownerDocument.sibling; ) {
                if (
                  ...
                  ownerDocument.return === workInProgress2
                )
                  break a;
          ...
          if (popHydrationState(workInProgress2)) {
            ...
            current =
              ...
              checkForUnmatchedText(current.nodeValue, renderLanes2)
                ? !0
                : !1;
            current || throwOnHydrationMismatch(workInProgress2, !0);
          } else
            (current =
      ...
      case 31:
        ...
        if (null === current || null !== current.memoizedState) {
          ...
          if (null !== renderLanes2) {
            ...
            (renderLanes2 = upgradeHydrationErrorsToRecoverable()),
              null !== current &&
                null !== current.memoizedState &&
                (current.memoizedState.hydrationErrors = renderLanes2),
              (current = !0);
          if (!current) {
            if (workInProgress2.flags & 256)
      ...
      case 13:
        ...
        renderLanes2 !== current &&
          renderLanes2 &&
          (workInProgress2.child.flags |= 8192);
      ...
      case 10:
        return (
          popProvider(workInProgress2.type),
          bubbleProperties(workInProgress2),
          null
        );
      case 19:
        ...
        if (null === nextResource)
            ...
            if (
              ...
              for (current = workInProgress2.child; null !== current; ) {
                ...
                if (null !== nextResource) {
                  ...
                  isHydrating &&
                    pushTreeFork(workInProgress2, newProps.treeForkCount);
                  return workInProgress2.child;
                }
                current = current.sibling;
              }
          ...
          newProps.isBackwards
            ? ((nextResource.sibling = workInProgress2.child),
              (workInProgress2.child = nextResource))
        ...
        return (
          ...
          newProps
            ? 0 !== (renderLanes2 & 536870912) &&
              0 === (workInProgress2.flags & 128) &&
              (bubbleProperties(workInProgress2),
              workInProgress2.subtreeFlags & 6 &&
                (workInProgress2.flags |= 8192))
            : bubbleProperties(workInProgress2),
    ...
    switch (workInProgress2.tag) {
      case 1:
        return (
          ...
          current & 65536
            ? ((workInProgress2.flags = (current & -65537) | 128),
              workInProgress2)
            : null
        );
      case 3:
  ...
  function commitBeforeMutationEffects(root2, firstChild) {
    ...
    if (hasSelectionCapabilities(root2)) {
      if ("selectionStart" in root2)
        ...
        a: {
          JSCompiler_temp =
            ((JSCompiler_temp = root2.ownerDocument) &&
    ...
    for (nextEffect = firstChild; null !== nextEffect; )
      if (
        ...
        0 !== (firstChild.subtreeFlags & 1028) && null !== root2)
      )
        ...
        for (; null !== nextEffect; ) {
          ...
          switch (firstChild.tag) {
            case 0:
              if (
                0 !== (root2 & 4) &&
                ((root2 = firstChild.updateQueue),
                (root2 = null !== root2 ? root2.events : null),
                null !== root2)
              )
                for (
                  JSCompiler_temp = 0;
                  JSCompiler_temp < root2.length;
                  JSCompiler_temp++
                )
                  (anchorOffset = root2[JSCompiler_temp]),
  ...
  function prepareFreshStack(root2, lanes) {
    ...
    -1 !== timeoutHandle &&
      ((root2.timeoutHandle = -1), cancelTimeout(timeoutHandle));
    timeoutHandle = root2.cancelPendingCommit;
    null !== timeoutHandle &&
      ((root2.cancelPendingCommit = null), timeoutHandle());
    pendingEffectsLanes = 0;
    ...
    if (0 !== allEntangledLanes)
      for (
        root2 = root2.entanglements, allEntangledLanes &= lanes;
        0 < allEntangledLanes;
  ...
  function throwAndUnwindWorkLoop(
    ...
    if (unitOfWork.flags & 32768) {
      if (isHydrating || 1 === suspendedReason) root2 = !0;
      else if (
        workInProgressRootIsPrerendering ||
        0 !== (workInProgressRootRenderLanes & 536870912)
      )
        ...
        ((workInProgressRootDidSkipSuspendedSiblings = root2 = !0),
        2 === suspendedReason ||
          9 === suspendedReason ||
          3 === suspendedReason ||
          6 === suspendedReason)
  ...
  function releaseRootPooledCache(root2, remainingLanes) {
    0 === (root2.pooledCacheLanes &= remainingLanes) &&
      ...
      null != remainingLanes &&
        ((root2.pooledCache = null), releaseCache(remainingLanes)));
  }
  ...
  function processRootScheduleInMicrotask() {
    ...
    for (
      var currentTime = now(), prev = null, root2 = firstScheduledRoot;
      null !== root2;
  ...
  function scheduleTaskForRootDuringMicrotask(root2, currentTime) {
    ...
    if (
      0 === (suspendedLanes & 3) ||
      checkIfRootIsPrerendering(root2, suspendedLanes)
    ) {
  ...
  function performWorkOnRootViaSchedulerTask(root2, didTimeout) {
    ...
    return null != root2.callbackNode &&
        ...
        ((href = assign(
          {
            rel: "preload",
            href:
              "image" === as && options2 && options2.imageSrcSet
                ? void 0
                : href,
            as,
          },
  ...
  function preloadModule(href, options2) {
    ...
    if (ownerDocument && href) {
      var as =
          options2 && "string" === typeof options2.as ? options2.as : "script",
        preloadSelector =
  ...
  function preinitScript(src, options2) {
    ...
    if (ownerDocument && src) {
      ...
      resource ||
        ...
        resource ||
          ((src = assign({ src, async: !0 }, options2)),
          (options2 = preloadPropsMap.get(key)) &&
  ...
  function preinitModuleScript(src, options2) {
    ...
    if (ownerDocument && src) {
      ...
      resource ||
        ...
        resource ||
          ((src = assign({ src, async: !0, type: "module" }, options2)),
          (options2 = preloadPropsMap.get(key)) &&
            adoptPreloadPropsForScript(src, options2),
          (resource = ownerDocument.createElement("script")),
          markNodeAsHoistable(resource),
  ...
  reactDomClient_production.createRoot = function (container, options2) {
    ...
    null !== options2 &&
      void 0 !== options2 &&
      (true === options2.unstable_strictMode && (isStrictMode = !0),
      void 0 !== options2.identifierPrefix &&
        (identifierPrefix = options2.identifierPrefix),
      void 0 !== options2.onUncaughtError &&
        (onUncaughtError = options2.onUncaughtError),
      void 0 !== options2.onCaughtError &&
        (onCaughtError = options2.onCaughtError),
...
export { requireReactDomClient_production as r };
